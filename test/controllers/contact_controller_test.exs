defmodule SreeShasta.ContactControllerTest do
  use SreeShasta.ConnCase

  alias SreeShasta.Contact
  @valid_attrs %{email: "some content", message: "some content", mobile: "some content", name: "some content"}
  @invalid_attrs %{}
